...
Button::Button(const string& nameP, Font& fontP, std::function<void()> onClickP, const Vector2& positionP,
               const Vector2& dimensionsP) :
    name(nameP),
    font(fontP),
...
void Button::setName(const string& nameP)
{
    name = nameP;
    if (nameTex)
    {
